    ...
    <main class="container">
        <div class="LayRecomended">
            <div class="wrapRecomended">
                <div class="wrapImg">
                    <figure class="img">
                        <img src="asset/Image/ea545f3990f88524a9472220454ab63bedc0b6aa.jpg" alt="" class="imgR">
                    </figure>
                </div>
                <div class="layHeader">
                    <header class="titleR">
                    ...
                    <button class="bookmarkButton" onclick="addToWishlist(1, 101)"> <!-- Example values for userId and paketId -->
                        <img src="asset/Icon/bookmark.png" alt="Bookmark" class="BMicon">
                    </button>
                </div>
                <div class="layPrice">
                ...
                <div class="layFooter">
                    ...
                    <a href="ContentDetail.html" class="arrowrightButton">
                        <img src="asset/Icon/arrow-right-square.png" alt="" class="ARicon">
                    </a>
                </div>
            </div>
        </div>
